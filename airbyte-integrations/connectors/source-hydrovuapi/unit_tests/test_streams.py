...
import pytest
from source_hydrovuapi.source import HydrovuapiStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(HydrovuapiStream, "path", "v0/example_endpoint")
    mocker.patch.object(HydrovuapiStream, "primary_key", "test_primary_key")
    mocker.patch.object(HydrovuapiStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = HydrovuapiStream()
