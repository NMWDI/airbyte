...
import pytest
from source_ckan.source import CkanStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(CkanStream, "path", "v0/example_endpoint")
    mocker.patch.object(CkanStream, "primary_key", "test_primary_key")
    mocker.patch.object(CkanStream, "__abstractmethods__", set())
