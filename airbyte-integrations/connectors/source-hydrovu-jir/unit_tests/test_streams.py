...
import pytest
from source_hydrovu_jir.source import HydrovuJirStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(HydrovuJirStream, "path", "v0/example_endpoint")
    mocker.patch.object(HydrovuJirStream, "primary_key", "test_primary_key")
    mocker.patch.object(HydrovuJirStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = HydrovuJirStream()
