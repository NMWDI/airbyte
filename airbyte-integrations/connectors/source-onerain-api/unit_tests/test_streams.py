...
import pytest
from source_onerain_api.source import OnerainApiStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(OnerainApiStream, "path", "v0/example_endpoint")
    mocker.patch.object(OnerainApiStream, "primary_key", "test_primary_key")
    mocker.patch.object(OnerainApiStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = OnerainApiStream()
